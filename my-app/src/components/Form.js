...
const schema = yup.object({
    ...
    telephone: yup.string().required("Telephone is a required field!").matches(/^(\+\d{2,3}\s)?\(?\d{3}\)?[\s.-]\d{2}[\s.-]\d{3}[\s.-]\d{4}$/, "Phone number must match the form 23000 00000"),
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
            <fieldset>
                <div className="field">
                    ...
                    <input type="text" placeholder="Joseph" name="name" {...register("name")} />
                ...
                <div className="field">
                    ...
                    <input type="tel" placeholder="23000 00000" name="telephone" {...register("telephone")}/>
